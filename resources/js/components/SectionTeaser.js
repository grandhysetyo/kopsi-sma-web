                ...
                <div className="row h-100">
                    <div className="col-lg-12 align-self-center" id="teaser-vid" data-aos="zoom-in-up" data-aos-delay="350">        
                        ...
                        <div className="col-lg-8 mx-auto">
                            <iframe src="https://www.youtube.com/embed/2tJea9KMerc" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                        </div>                                                             
                    </div>                                       
                </div>
            </div>
