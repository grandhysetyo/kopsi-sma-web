    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                <form id="validate_form" action="{{route('biodata.leader.save')}}" enctype="multipart/form-data" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="my-5">
                        <div class="flex flex-col bg-white">
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <div class="relative">
                                    <select name="ukuran_baju" required class="text-sm sm:text-base relative w-full border rounded placeholder-gray-400 focus:border-indigo-400 focus:outline-none py-2 pr-2 pl-6">
                                        <option @if($ketua->ukuran_baju == 'XS') selected @endif value="XS">XS</option>
                                        <option @if($ketua->ukuran_baju == 'S') selected @endif value="S">S</option>
                                        <option @if($ketua->ukuran_baju == 'M') selected @endif value="M">M</option>
                                        <option @if($ketua->ukuran_baju == 'L') selected @endif value="L">L</option>
                                        <option @if($ketua->ukuran_baju == 'XL') selected @endif value="XL">XL</option>
                                        <option @if($ketua->ukuran_baju == 'XXL') selected @endif value="XXL">XXL</option>
                                        <option @if($ketua->ukuran_baju == 'XXXL') selected @endif value="XXXL">XXXL</option>
                                    </select>
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <div class="relative">
                                    <select name="jurusan" required class="text-sm sm:text-base relative w-full border rounded placeholder-gray-400 focus:border-indigo-400 focus:outline-none py-2 pr-2 pl-6">
                                        <option @if ($ketua->jurusan == 'IPA') selected @endif value="IPA">IPA</option>
                                        <option @if ($ketua->jurusan == 'IPS') selected @endif value="IPS">IPS</option>
                                        <option @if ($ketua->jurusan == 'Bahasa') selected @endif value="Bahasa">Bahasa</option>
                                    </select>
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <div class="relative">
                                    <textarea name="alamat_siln" class="text-sm sm:text-base relative w-full border rounded placeholder-gray-400 focus:border-indigo-400 focus:outline-none py-2 pr-2 pl-6">{{$ketua->alamat_siln}}</textarea>
                                </div>
                            </div>
                            <div class="flex flex-col mb-4">
                                <label for="name"
