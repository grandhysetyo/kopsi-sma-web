...
<html lang="en-us" id="extr-page">
	...
	<body id="login">
		...
		<header id="header">
			...
			<div id="logo-group">
				<span id="logo"> <img src="img/logo.png" alt="KoPSI Logo"> </span>

				<!-- END AJAX-DROPDOWN -->
			</div>

			<span id="extr-page-header-space"> <span class="hidden-mobile">Sudah Mendaftar?</span> <a href="index.php" class="btn btn-danger">Masuk</a> </span>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
						...
						<div class="hero">
							<div class="pull-left login-desc-box-l">
                                ...
                                <p>Jika kamu <strong>KELOMPOK</strong>, kamu wajib berkoordinasi dengan tim kamu dan gunakan email <strong>KELOMPOK</strong> yang valid untuk melakukan pendaftaran.</p> 
                                <p><strong>ANGGOTA</strong> dalam kelompok tidak perlu melakukan pendaftaran. Cukup Ketua/Leader yang mendaftarkan Anggotanya.</p>
                                <p>Jika kamu <strong>INDIVIDU</strong>, Silakan gunakan email pribadi yang valid.</p>
                                <p>Apabila ditemukan <strong>Duplikasi dalam Pendaftaran</strong>, Akan dilakukan <strong>Diskualifikasi</strong>.</p>
								
							</div>
							
							
							<img src="img/demo/opsi.png" alt="" class="pull-right display-image" style="width:210px">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
							...
							<form action="register.php" id="smart-form-register" class="form-horizontal contactform smart-form client-form" method="post" onsubmit="return validateForm();">
								<header>
								...
								<fieldset>
									<section>
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="text" placeholder="Tulis Nama Kamu" id="uname" class="form-control" name="uname">
											<!--<b class="tooltip tooltip-bottom-right">Needed to enter the website</b>--> </label>
									</section>

									<section>
										<label class="input"> <i class="icon-append fa fa-envelope"></i>
											<input type="text" placeholder="Tulis alamat email kamu" id="uemail" class="form-control" name="uemail">
									...
									<section>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
											<input type="password" placeholder="Buat Password / kata kunci" id="pass1" class="form-control" name="pass1">
											<b class="tooltip tooltip-bottom-right">ingat kata kunci ini dan jangan diberitahukan kepada siapapun.</b> </label>
									</section>

									<section>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
											<input type="password" placeholder="Tulis Kembali Password/kata kunci" id="pass2" class="form-control" name="pass2">
											<b class="tooltip tooltip-bottom-right">Tulis Kembali Password/kata kunci yang kamu buat</b> </label>
									</section>
								</fieldset>
