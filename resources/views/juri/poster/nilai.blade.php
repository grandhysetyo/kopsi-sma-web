...
<h2 class="font-semibold text-xl text-gray-800 leading-tight">
    Nilai Poster {{$poster->tim->nama_karya}}
</h2>  
@endsection
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                <form id="validate_form" action="{{route('simpan_nilai_poster', $poster->id)}}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="my-5">
                        <div class="flex flex-col bg-white">
                            <div class="flex flex-col mb-4">
                                ...
                                @else
                                    <div>
                                        <embed style="width: 100%; height: 500px" class="embed-responsive-item" src="{{asset('uploads/'.$poster->poster)}}">
                                    </div>
                                    <h2>atau</h2>
                                    <div class="m-5"><a target="_blank" type="button" href="{{asset('uploads/'.$poster->poster)}}"
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <div class="relative">
                                    <textarea name="komentar" class="text-sm sm:text-base relative w-full border rounded placeholder-gray-400 focus:border-indigo-400 focus:outline-none py-2 pr-2 pl-6"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
