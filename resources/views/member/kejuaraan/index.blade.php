...
<a href="{{route('kejuaraan-member.create')}}" style="float: right" class='bg-blue-500 text-white p-2 rounded text-l font-bold'>Tambah Prestasi</a>
@endsection
<div class="py-12">
...
<script>
    (function($) {
     ...
     $('#example').DataTable({
      ...
      responsive: true,
      ajax:{
       url: "{{ route('kejuaraan-member.index') }}",
      },
      columns:[
       {
        data: 'judul',
